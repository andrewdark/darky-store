...
const Profile = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-8 font-primary bg-normalbg dark:bg-darkbg">
            ...
            <Form method="PUT" className="space-y-6 max-w-3xl mx-auto">
                <div>
                    ...
                    <input id="name" name="name" type="text" placeholder="Your Name" className={textFieldStyle} value={profileData.name}
                        onChange={(e) =>

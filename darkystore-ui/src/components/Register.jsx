...
import { Form, Link, useActionData, useNavigation, useNavigate, useSubmit, } from "react-router-dom";
...
const Register = () => {
    ...
    const labelStyle =
        "block text-lg font-semibold text-primary dark:text-light";
    ...
    return (
        <div className="flex items-center justify-center font-primary dark:bg-darkbg">
            <div className="bg-white dark:bg-gray-700 shadow-md rounded-lg max-w-md w-full px-8 py-2">
...
export async function registerAction({ request }) {
    ...
    try {
        ...
        return { success: true, user: response.data ?? null };
    } catch (error) {
